...
const services = [
  ...
  },
  {
    icon: Footprints,
    title: "Pet Walking",
    description: "Daily walks with GPS tracking. Keep your pet active and healthy.",
    price: "₹299",
  ...
  },
  {
    icon: GraduationCap,
    title: "Pet Training",
    description: "Obedience training, socialization, and behavior correction by certified trainers.",
    price: "₹1,999",
  ...
  },
  {
    ...
    description: "Online and at-home veterinary consultations. Quick, reliable, and affordable.",
    price: "₹499",
