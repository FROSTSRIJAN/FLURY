...
const allServices = [
  ...
  },
  {
    ...
    description: "Membership for caretakers that boosts their visibility to people searching for temporary pet care.",
    price: "₹199",
    duration: "Per month",
    rating: 4.9,
    reviews: 3100,
    benefits: ["Higher listing visibility", "Priority in search", "Boosted profile trust", "More booking opportunities"],
  ...
  },
  {
    ...
    description: "Join local pet parent and caretaker communities for support, events, and trusted recommendations.",
    price: "Free of cost",
    duration: "No charges",
    rating: 4.7,
    reviews: 980,
    benefits: ["Local pet communities", "Discussion spaces", "Events and meetups", "Shared recommendations"],
  ...
  },
  {
    ...
    icon: Stethoscope,
    title: "Team Furly",
    description: "Connect with Team Furly for updates, support initiatives, and platform-led pet care activities.",
    price: "Free of cost",
    duration: "No charges",
    rating: 4.9,
    reviews: 1560,
    benefits: ["Platform updates", "Support network", "Community initiatives", "Curated opportunities"],
